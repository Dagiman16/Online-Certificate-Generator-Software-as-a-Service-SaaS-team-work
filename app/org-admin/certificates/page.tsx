...
export default function CertificatesPage() {
  ...
  const certificates = [
    {
      ...
      verificationCount: 3,
      downloadCount: 5,
      qrCode: `${typeof window !== 'undefined' ? window.location.origin : ''}/verify?id=CERT-2024-001`
    },
    {
      id: 'CERT-2024-002',
      ...
      verificationCount: 1,
      downloadCount: 2,
      qrCode: `${typeof window !== 'undefined' ? window.location.origin : ''}/verify?id=CERT-2024-002`
    },
    {
      id: 'CERT-2024-003',
      ...
      verificationCount: 0,
      downloadCount: 0,
      qrCode: `${typeof window !== 'undefined' ? window.location.origin : ''}/verify?id=CERT-2024-003`
    },
    {
      id: 'CERT-2024-004',
      ...
      verificationCount: 7,
      downloadCount: 12,
      qrCode: `${typeof window !== 'undefined' ? window.location.origin : ''}/verify?id=CERT-2024-004`
    },
    {
      id: 'CERT-2024-005',
      traineeName: 'David Brown',
      traineeEmail: 'david.brown@email.com',
      trainingProgram: 'Cybersecurity Fundamentals',
      issueDate: '2024-01-11',
      status: 'revoked',
      template: 'Modern Green',
      verificationCount: 2,
      downloadCount: 3,
      qrCode: `${typeof window !== 'undefined' ? window.location.origin : ''}/verify?id=CERT-2024-005`
    }
  ]
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'revoked': return <ExclamationTriangleIcon className="h-4 w-4" />
      default: return null
    }
  }
  ...
  const handleBulkDownload = () => {
    console.log('Bulk downloading certificates')
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-secondary-600 mt-1">View and manage issued certificates</p>
          </div>
          <div className="flex space-x-3">
            <button onClick={handleBulkDownload} className="btn-secondary">
              <ArrowDownTrayIcon className="h-5 w-5 mr-2" />
              Bulk Download
            </button>
            <Link href="/org-admin/certificates/design" className="btn-secondary">
              <SwatchIcon className="h-5 w-5 mr-2" />
              Design Certificate
            </Link>
            <Link href="/org-admin/certificates/generate-enhanced" className="btn-primary">
        ...
        <div className="card">
                ...
                {filteredCertificates.map((certificate) => (
                  <tr key={certificate.id} className="hover:bg-secondary-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-secondary-900">
                      <div>
                        <div>{certificate.verificationCount} verifications</div>
                        <div className="text-xs text-secondary-500">{certificate.downloadCount} downloads</div>
                      </div>
                    </td>
          ...
          {filteredCertificates.length === 0 && (
            <div className="text-center py-12">
              ...
              {!searchTerm && statusFilter === 'all' && dateFilter === 'all' && (
                <Link href="/org-admin/certificates/generate" className="btn-primary">
                  <PlusIcon className="h-5 w-5 mr-2" />
                  Generate Certificate
                </Link>
              )}
              ...
              <div className="text-center space-y-4">
                ...
                <div className="text-left space-y-2">
                  <div>
                    ...
                    <p className="font-mono text-sm text-secondary-900">{selectedCertificate.id}</p>
                  </div>
                  <div>
