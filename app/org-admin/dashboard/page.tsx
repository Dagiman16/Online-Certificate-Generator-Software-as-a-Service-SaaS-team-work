  ...
  const quickStartSteps = [
    {
      ...
      href: '/org-admin/trainings/create',
      icon: AcademicCapIcon,
      completed: false
    },
    {
      ...
      href: '/org-admin/trainees/import',
      icon: UsersIcon,
      completed: false
    },
    {
    ...
    },
    {
      ...
      href: '/org-admin/certificates/generate',
      icon: SparklesIcon,
      completed: false
    }
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              <Link href="/org-admin/certificates/generate" className="block p-4 border border-secondary-200 rounded-xl hover:bg-secondary-50 transition-colors">
                <div className="flex items-center">
              ...
              <Link href="/org-admin/trainees/import" className="block p-4 border border-secondary-200 rounded-xl hover:bg-secondary-50 transition-colors">
                <div className="flex items-center">
              ...
              <Link href="/org-admin/trainings/create" className="block p-4 border border-secondary-200 rounded-xl hover:bg-secondary-50 transition-colors">
                <div className="flex items-center">
