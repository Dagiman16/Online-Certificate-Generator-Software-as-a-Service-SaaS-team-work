...
export default function TraineesPage() {
  ...
  const stats = {
    ...
    totalCertificates: trainees.reduce((sum, t) => sum + t.certificatesEarned, 0)
  }
  ...
  const handleBulkAction = (action: string) => {
    console.log(`Performing ${action} on trainees:`, selectedTrainees)
    setSelectedTrainees([])
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-secondary-600 mt-1">Manage your training participants and track their progress</p>
          </div>
          <div className="flex space-x-3">
            <Link href="/org-admin/trainees/bulk-import" className="btn-secondary">
            ...
            <Link href="/org-admin/trainees/manual-registration" className="btn-primary">
          ...
          <div className="card">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-secondary-100 rounded-xl flex items-center justify-center mr-4">
                <span className="text-secondary-600 font-bold text-lg">{stats.totalCertificates}</span>
              </div>
              <div>
                <p className="text-sm font-medium text-secondary-600">Certificates</p>
                <p className="text-2xl font-bold text-secondary-900">{stats.totalCertificates}</p>
              </div>
            </div>
          </div>
        </div>
